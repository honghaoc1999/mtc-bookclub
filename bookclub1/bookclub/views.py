...
from bookclub.forms import ProfileForm, RegisterForm, LoginForm, PostForm
...
def room_action(request, room_user_name):
    ...
    room_name = room_user_name[:name_split]
...
def global_stream(request):
    ...
    if 'pdf' not in request.POST or not request.POST['pdf']:
        # no pdf
        return render(request, 'error.html', {'errorMessage': "Invalid post without pdf (global stream). "})
