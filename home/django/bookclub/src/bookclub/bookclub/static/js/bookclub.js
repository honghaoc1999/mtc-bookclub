...
btnJoinRoom && btnJoinRoom.addEventListener('click', () => {
  username = inputUsername.value;
  roomname = inputRoomname.value;
  if (username.indexOf('+') >= 0 || roomname.indexOf('+') >= 0) {
    return errorInput("Please do not include + character in user name or room name");
  }

  window.location.pathname = '/chatroom/' + roomname + '+' + username + '/';
  console.log("we don't want here")
...
if (inputUsername && inputUsername.disabled == false && inputUsername.value == '') {
